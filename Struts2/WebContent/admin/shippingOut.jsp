	...
	<div class="main">
		...
		<div class="main1">
			...
			<div class="box">
				...
				<br />
				<ul class="count">
					<li><form action="adminoutOrder" method="post" onsubmit="return checkForm(this)">
							<input
								...
								type="text" hidden="hidden" name="order.tag" value="0" /> <input
								hidden="hidden" type="text" id="name" name="order.name"
								value="出货" /><br> <input id="phone" hidden="hidden"
							...
							<br> <input type="text" hidden="hidden" name="type.id"
								value="0"> <span id="num-jian" class="num-jian">-</span>&nbsp;&nbsp;&nbsp;
							<input class="input-num" id="input-num" name="order.number"
								value="0" style="color: red; width: 50px;" />&nbsp;&nbsp;&nbsp;
							<span id="num-jia" class="num-jia">+</span> <span class="kucun">（库存:<s:property
									value="type.number" />）
							</span><br>
							<br> <input type="submit" onclick="false" value="立即出货" />
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input
								type="reset" value="重填" />
						</form></li>
				</ul>
