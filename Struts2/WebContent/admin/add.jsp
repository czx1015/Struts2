		...
		<div class="main1">
			<div class="middle">
				<form action="addUser" method="post"
					...
					<div>
						密码&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;：<input
							type="password" id="pwd" name="user.pwd" value="" />
					</div>
					...
					<div>
						电话号码：<input id="phone" name="user.phone" value="" />
					</div>
					<span style="color: red;">*1开头其余为0~9长度为11的数字</span><br> <br>
					<input checked type="radio" name="user.role" value="0">普通用户
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input
						type="radio" name="user.role" value="1">店家
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input
						type="radio" name="user.role" value="2">管理员<br> <br>
					<input type="submit" onclick="false" value="添加" />
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input
						type="reset" value="重填" />
				</form>
			</div>
